...
AdaBoost, gradient boosting, voting, stacking and blending) on top of a small
CART decision tree so that the whole workflow is dependency-light and easy to
follow.
"""
